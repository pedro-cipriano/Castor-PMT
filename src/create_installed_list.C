...
void create_installed_list(string *trees_in, int ini_file, int end_file)
{
//cout << "load tree"<<endl;
//opening the file
...
cout << pmt << " " << inst_sector << " " <<inst_module << " " << inst_gain1200 << " " << m_1200V_led1.gain_error << " " << inst_qe1200 << " " << m_1200V_led1.qe_error<< endl;
}
...
cout << pmt << " " << inst_sector << " " <<inst_module << " " << m_1200V_led1.gain_value << " " << m_1200V_led1.gain_error << " " << m_1200V_led1.qe_value << " " << m_1200V_led1.qe_error<< endl;
}
if (inst_gain1200 > 0.0 and inst_qe1200 == 0.0)
{
pmt_gain_1200_qe_inst->SetBinContent(inst_module,inst_sector,inst_gain1200*m_1200V_led1.qe_value);
cout << pmt << " " << inst_sector << " " <<inst_module << " " << inst_gain1200 << " " << m_1200V_led1.gain_error << " " << m_1200V_led1.qe_value << " " << m_1200V_led1.qe_error<< endl;
}
if (inst_gain1200 == 0.0 and inst_qe1200 > 0.0)
{
pmt_gain_1200_qe_inst->SetBinContent(inst_module,inst_sector,m_1200V_led1.gain_value*inst_qe1200);
cout << pmt << " " << inst_sector << " " <<inst_module << " " << m_1200V_led1.gain_value << " " << m_1200V_led1.gain_error << " " << inst_qe1200 << " " << m_1200V_led1.qe_error<< endl;
}
